...
function renderInvoiceHTML(company, customer, order, invoice) {
  if (!invoice) {
    ...
    <div class="card">
      ...
      <form id="f">
        <label>Subtotal</label><input name="subtotal" type="number" step="0.01" value="0" min="0">
        <label>IVA / Impuesto</label><input name="tax" type="number" step="0.01" value="0" min="0">
